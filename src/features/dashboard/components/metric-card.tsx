...
export function MetricCard({ title, value, previousValue, icon, description, format = "number" }: MetricCardProps) {
      ...
      <CardContent>
        ...
        {trend && (
          <div className="text-muted-foreground mt-1 flex items-center gap-1 text-xs">
            ...
            <span className={cn(getTrendColor(trend.direction))}>{trend.percentage}%</span>
            <span>vs ayer</span>
          </div>
        )}
